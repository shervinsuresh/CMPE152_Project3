...
enum class PascalTokenType
{
    ...
    THEN, TO, TYPE, UNTIL, VAR, WHILE, WITH,WHEN,OTHERWISE,SYM,
...
constexpr PascalTokenType PT_SYM = PascalTokenType::SYM;
...
constexpr PascalTokenType PT_SETTER = PascalTokenType::SETTER;
